...
> :point_right: &nbsp; See [my working example](https://random-quote.fortc.com).
...
The example site is built [from this GitHub repository](https://github.com/dfinr/hugo-random-quotes). Here's how to add the same feature to your Hugo site.
